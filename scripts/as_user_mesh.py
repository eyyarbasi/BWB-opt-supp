...
The fuel burn from the cruise flight-point is the objective function and a 2.25g
...
root_chord = 150  # root chord in m
kink_chord = 38.66  # kink chord in m section 19
tip_chord = 8.28  # tip ch
...
x_LE[ny_inboard : ny_inboard + ny_outboard] = array_for_outboard_leading_edge_x_coord[
    1:
]
...
x_TE[ny_inboard : ny_inboard + ny_outboard] = array_for_outboard_trailing_edge_x_coord[
    1:
]
...
indep_var_comp.add_output(
    ...
    val=np.array(
        [
            0.569 * 310.95 * 0.5 * 1.0 / (1.56 * 1e-5),
